...
* [Nick Fitzgerald](http://fitgeraldnick.com/weblog/62/) has a compelling
  argument about the limitations of Source Maps at encoding things like scoping
  information.  For Syntex, this doesn't matter since it's source language is
  also Rust, but if a language like
